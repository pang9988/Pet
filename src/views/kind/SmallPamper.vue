<template>
    <div class="small" ref="movie">
        <div>
        <div>{{pullDownMsg}}</div>
        <!-- 小宠商品列表组件 -->
            <div class="kind-pamper">
                <div class="kind-pamper-item" v-for="(elem,i) of list" :key="i" @click="goproduct(elem.pid)">
                    <img :src="'http://pelww.applinzi.com/' + elem.Pimg" alt="图片已损坏">
                    <p>{{elem.pname}}</p>
                    <div class="pamper-price">
